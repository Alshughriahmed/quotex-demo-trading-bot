...
from backtest_strategy import load_candles, run_backtest  # noqa: E402
...
def print_table(rows: list[SweepRow], limit: int) -> None:
    ...
    header = "rank | duration | min_conf | lookback | step | trades | wins | losses | win_rate | score"
    print(header)
    print("-" * len(header))
